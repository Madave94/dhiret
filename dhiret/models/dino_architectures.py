...
from dhiret.common.dino_utils import trunc_normal_
...
def dino_vits16(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        print("Loading pretrained weights for dino_vits16.")
    return model
...
def dino_vits8(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(state_dict, strict=True)
        print("Loading pretrained weights for dino_vits8.")
    return model
...
def dino_vitb16(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(state_dict, strict=True)
        print("Loading pretrained weights for dino_vitb16.")
    return model
...
def dino_vitb8(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(state_dict, strict=True)
        print("Loading pretrained weights for dino_vitb8.")
    return model
